...
private:
	...
	void DrawWorkshopOptions(WORKSHOP_OPTIONS SavedOptions[], int WorkshopOptionsCount, string WorkshopOptions[]) const;
	void DrawEquipmentOptions(WORKSHOP_EQUIPMENT Equipments[], int EquipmentCount, string WorkshopEquipments[]) const;
...
public:
	...
	void CreateWorkshopOptions(WORKSHOP_OPTIONS SavedOptions[], int OptionsCount) const;
	void CreateEquipmentOptions(WORKSHOP_EQUIPMENT Equiments[], int EquipmentsCount) const;
